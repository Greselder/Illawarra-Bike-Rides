var size = 0;
var placement = 'point';
function categories_WindangtoWarrawong_16(feature, value, size, resolution, labelText,
...
var style_WindangtoWarrawong_16 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_WindangtoWarrawong_16(feature, value, size, resolution, labelText,
